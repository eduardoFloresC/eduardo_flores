...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-09-2019 a las 21:44:17
...
INSERT INTO `usuarios` (`usr_id`, `usr_alias`, `usr_apellido`, `usr_nombre`, `provincia_id`, `email`) VALUES
(2, 'edward', 'Flores', 'Eduardo', 1, 'x_edu88@hotmail.com'),
(3, 'madMax', 'Perez', 'Martin', 2, 'madmax@gmail.com');
...
--
ALTER TABLE `provincias`
  MODIFY `provincia_id` tinyint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `usuarios`
--
ALTER TABLE `usuarios`
  MODIFY `usr_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
